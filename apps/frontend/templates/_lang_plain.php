...
<?php foreach($user_cultures_data as $culture => $culture_data): ?>
    ...
    <?php else: ?>
        <a href="http://<?php echo $app_domain_name . '/'.$culture.$params; ?>" title="<?php echo $culture_data['name'] ?>" <?php if (isset($culture_data['large_text']) && $culture_data['large_text']): ?>class="large_culture"<?php endif ?> rel="nofollow"><?php echo $culture_data['name'] ?></a>
    <?php endif ?>
