...
<?php if (!get_slot('share_items')): ?>
    <?php include_partial('global/like', array('identifier'=>CommentsPeer::getCommentsIdentifier(sfConfig::get('sf_default_culture'))));  ?>
<?php endif ?>
...
<div class="s_item">
    <script type="text/javascript">
        window.___gcfg = {lang: '<?php echo $sf_user->getCulture(); ?>'};
    </script>
