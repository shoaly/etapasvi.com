...
<?php endif ?>
<?php echo __('Website is developed and supported on a voluntary basis.') ?><br/><?php echo __('If you can help in any way – email at') ?> <a href="mailto:<?php echo UserPeer::MAIL_ADDRESS ?>"><?php echo UserPeer::MAIL_ADDRESS ?></a>
