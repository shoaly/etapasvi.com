...
<ol class="contents">
<?php /*		<li><a href="#gautama_buddha"><?php echo __('Gautama Buddha (Siddhartha, Sakyamuni, Tathagata)') ?></a></li>*/ ?>
<?php /*		<li><a href="#ten_characteristics_of_buddha"><?php echo __('Ten Characteristics of Buddha') ?></a></li>*/ ?>
<?php /*		<li><a href="#middle_way"><?php echo __('Middle Way') ?></a></li>
...
<?php /*		<li><a href="#moksha"><?php echo __('Moksha') ?></a></li>*/ ?>
...
<?php /*		<li><a href="#refuge"><?php echo __('Refuge') ?></a></li>*/ ?>
...
<?php /*        <li><a href="#tummo"><?php echo __('Tummo') ?></a></li>*/ ?>

    <li><a href="#bodhisattva"><?php echo __('Bodhisattva') ?></a></li>
<?php /*		<li><a href="#six_paramitas"><?php echo __('Six paramitas (perfections)') ?></a></li>*/ ?>
<?php /*		<li><a href="#dhyana"><?php echo __('Dhyana') ?></a></li>*/ ?>
    <li><a href="#arhat"><?php echo __('Arhat') ?></a></li>
<?php /*		<li><a href="#anuttara_samyak_sambodhi"><?php echo __('Samyak Sambodhi (Anuttara-samyak-sambodhi)') ?></a></li> */ ?>
<?php /*		<li><a href="#maitreya"><?php echo __('Maitreya') ?></a></li>*/ ?>
<?php /*		<li><a href="#asanga"><?php echo __('Asanga') ?></a></li>
...
<?php /*		<li><a href="#atman"><?php echo __('Atman (Buddhism)') ?></a></li>
...
<?php /*<h2 id="ten_characteristics_of_buddha"><?php echo ++$counter; ?>. <?php echo __('Ten Characteristics of Buddha') ?></h2>
<ol>
...
<?php include_partial('global/go_to_top'); ?>*/?>
<?php /*<h2 id="middle_way"><?php echo ++$counter; ?>. <?php echo __('Middle Way') ?></h2>
...
<?php include_partial('global/go_to_top'); ?>
<?php /*<h2 id="moksha"><?php echo ++$counter; ?>. <?php echo __('Moksha') ?></h2>
...
<?php/*<?php echo __('The Dharma, as the liberating law discovered and proclaimed by the Buddha, is summed up in the Four Noble Truths. Beings that live in accordance with Dharma proceed more quickly toward nirvana (personal liberation).') ?>
<br/><br/>
...
<?php echo __('Dharma in the Buddhist scriptures has a variety of meanings, including "phenomenon" and "nature" or "characteristic".') ?>
<br/><br/>
...
<?php include_partial('global/go_to_top'); ?>*/ ?>
<?php/*<h2 id="refuge"><?php echo ++$counter; ?>. <?php echo __('Refuge') ?></h2>
...
<?php include_partial('global/go_to_top'); ?>*/ ?>
<?php /*<h2 id="dhyana"><?php echo ++$counter; ?>. <?php echo __('Dhyana') ?></h2>
...
<?php include_partial('global/go_to_top'); ?>
*/ ?>
<?php /*<h2 id="atman"><?php echo ++$counter; ?>. <?php echo __('Atman (Buddhism)') ?></h2>
