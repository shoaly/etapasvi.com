...
*/ ?>
    ...
    <?php if ($sf_user->getCulture() == 'ru'): ?>
         ...
         <a href="http://vk.com/etapasvi" target="_blank" title="<?php echo __('ВКонтакте') ?>" class="social_vkontakte" rel="nofollow"><span><?php echo __('ВКонтакте') ?></span></a><br/>
    <?php /* <?php else: ?>
    ...
    <? else: ?>
        <a href="https://picasaweb.google.com/105320929368395530858" target="_blank" title="<?php echo __('Picasa') ?>" class="social_picasa" rel="nofollow"><span><?php echo __('Picasa') ?></span></a>
    <? endif ?>
    <br/>
