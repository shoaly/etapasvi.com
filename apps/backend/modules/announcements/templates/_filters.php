...
<?php echo form_tag('announcements/list', array('method' => 'get')) ?>
...
<div class="form-row">
  ...
  <ul class="sf_admin_actions">
    <li><?php echo button_to(__('reset'), 'announcements/list?filter=filter', 'class=sf_admin_action_reset_filter') ?></li>
