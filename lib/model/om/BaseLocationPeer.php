...
abstract class BaseLocationPeer {
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'LocationId', 'CreatedAt', 'Show', 'Order', 'Lat', 'Lng', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'locationId', 'createdAt', 'show', 'order', 'lat', 'lng', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::LOCATION_ID, self::CREATED_AT, self::SHOW, self::ORDER, self::LAT, self::LNG, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'location_id', 'created_at', 'show', 'order', 'lat', 'lng', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'LocationId' => 1, 'CreatedAt' => 2, 'Show' => 3, 'Order' => 4, 'Lat' => 5, 'Lng' => 6, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'locationId' => 1, 'createdAt' => 2, 'show' => 3, 'order' => 4, 'lat' => 5, 'lng' => 6, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::LOCATION_ID => 1, self::CREATED_AT => 2, self::SHOW => 3, self::ORDER => 4, self::LAT => 5, self::LNG => 6, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'location_id' => 1, 'created_at' => 2, 'show' => 3, 'order' => 4, 'lat' => 5, 'lng' => 6, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(LocationPeer::LOCATION_ID);
		$criteria->addSelectColumn(LocationPeer::CREATED_AT);
		$criteria->addSelectColumn(LocationPeer::SHOW);
		$criteria->addSelectColumn(LocationPeer::ORDER);
	...
	{
		// invalidate objects in LocationI18nPeer instance pool, since one or more of them may be deleted by ON DELETE CASCADE rule.
	...
	public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		LocationPeer::addSelectColumns($criteria);
		$startcol2 = (LocationPeer::NUM_COLUMNS - LocationPeer::NUM_LAZY_LOAD_COLUMNS);
	...
	public static function doDeleteAll($con = null)
	{
		...
		try {
			...
			$con->beginTransaction();
			$affectedRows += LocationPeer::doOnDeleteCascade(new Criteria(LocationPeer::DATABASE_NAME), $con);
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		try {
			...
			// for more than one table or we could emulating ON DELETE CASCADE, etc.
			$con->beginTransaction();
			$affectedRows += LocationPeer::doOnDeleteCascade($criteria, $con);
	...
	protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
	{
		...
		foreach ($objects as $obj) {
			...
			// delete related LocationI18n objects
			$criteria = new Criteria(LocationI18nPeer::DATABASE_NAME);
			
			$criteria->add(LocationI18nPeer::ID, $obj->getId());
			$affectedRows += LocationI18nPeer::doDelete($criteria, $con);
		}
		return $affectedRows;
	}
	...
	/**
	 * Selects a collection of {@link Location} objects with a {@link LocationI18n} translation populated.
	 *
	 * @param Criteria  $criteria
	...
	static public function doSelectWithI18n(Criteria $criteria, $culture = null, $con = null, $join_behavior = Criteria::LEFT_JOIN, $special_join = false)
	{
	  ...
	  LocationPeer::addSelectColumns($criteria);
	  $startcol = (LocationPeer::NUM_COLUMNS - LocationPeer::NUM_LAZY_LOAD_COLUMNS);
	  LocationI18nPeer::addSelectColumns($criteria);
	  // http://bsds.etapasvi.com/issues/113 
	  //$criteria->addJoin(LocationPeer::ID, LocationI18nPeer::ID, $join_behavior);
	  ...
	  if ($special_join) {
	    ...
	    $criteria->addJoin(
	      array(LocationPeer::ID, "(".LocationI18nPeer::CULTURE),
	      array(LocationI18nPeer::ID, "'{$culture}' OR 
					(".LocationI18nPeer::CULTURE." = '{$default_culture}' AND NOT EXISTS(SELECT ".LocationI18nPeer::ID." FROM ".LocationI18nPeer::TABLE_NAME." 
					WHERE ".LocationI18nPeer::ID." = ".LocationPeer::ID." AND ".LocationI18nPeer::CULTURE." = '{$culture}')))"), 
	      $join_behavior
	    );
	  } else {
	    $criteria->addJoin(array(LocationPeer::ID, LocationI18nPeer::CULTURE), array(LocationI18nPeer::ID, "'$culture'"), $join_behavior);
	  }  
	
	  foreach (sfMixer::getCallables('BaseLocation:doSelectJoin:doSelectJoin') as $sf_hook)
	  {
	    call_user_func($sf_hook, 'Location', $criteria, $con);
	  }
	  ...
	  $stmt = BasePeer::doSelect($criteria, $con);
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
	      ...
	      LocationPeer::addInstanceToPool($obj1, $key1);
			...
			$key2 = LocationI18nPeer::getPrimaryKeyHashFromRow($row, $startcol);
			if ($key2 !== null) {
				$obj2 = LocationI18nPeer::getInstanceFromPool($key2);
				if (!$obj2) {
					$cls = LocationI18nPeer::getOMClass(false);
					$obj2 = new $cls();
					$obj2->hydrate($row, $startcol);
					LocationI18nPeer::addInstanceToPool($obj2, $key2);
				} // if obj2 already loaded
	
	      $obj1->setLocationI18nForCulture($obj2, $culture);
