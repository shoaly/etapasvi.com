...
/**
 * Base class that represents a row from the 'video_i18n' table.
 *
 * 
 *
 ...
 */
abstract class BaseVideoI18n extends BaseObject  implements Persistent {
	 ...
	 * @return     VideoI18n The current object (for fluent API support)
	 */
	public function setUpdatedAtExtra($v)
	{
		...
		if ( $this->updated_at_extra !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = VideoI18nPeer::UPDATED_AT_EXTRA;
			}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->img = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
			...
			return $startcol + 8; // 8 = VideoI18nPeer::NUM_COLUMNS - VideoI18nPeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating VideoI18n object", $e);
		}
	}
	...
	public function ensureConsistency()
	{
		...
		if ($this->aVideo !== null && $this->id !== $this->aVideo->getId()) {
			$this->aVideo = null;
		}
	} // ensureConsistency
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = VideoI18nPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			...
			foreach (sfMixer::getCallables('BaseVideoI18n:delete:pre') as $callable)
			{
			...
			if ($ret) {
				VideoI18nPeer::doDelete($this, $con);
				$this->postDelete($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BaseVideoI18n:delete:post') as $callable)
				{
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			// symfony_behaviors behavior
			foreach (sfMixer::getCallables('BaseVideoI18n:save:pre') as $callable)
			{
			...
			if ($ret) {
				...
				$this->postSave($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BaseVideoI18n:save:post') as $callable)
				{
				  call_user_func($callable, $this, $con, $affectedRows);
				}

				VideoI18nPeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->aVideo !== null) {
				if ($this->aVideo->isModified() || ($this->aVideo->getCulture() && $this->aVideo->getCurrentVideoI18n()->isModified()) || $this->aVideo->isNew()) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					...
					if ($has_non_empty_fields || ($only_service_fields_modified && !$is_i18n)) {
						$pk = VideoI18nPeer::doInsert($this, $con);
					...
					$affectedRows += VideoI18nPeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = VideoI18nPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = VideoI18nPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = VideoI18nPeer::getFieldNames($keyType);
		$result = array(
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[1], $arr)) $this->setImg($arr[$keys[1]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(VideoI18nPeer::UPDATED_AT_EXTRA)) $criteria->add(VideoI18nPeer::UPDATED_AT_EXTRA, $this->updated_at_extra);
		if ($this->isColumnModified(VideoI18nPeer::IMG)) $criteria->add(VideoI18nPeer::IMG, $this->img);
		if ($this->isColumnModified(VideoI18nPeer::CODE)) $criteria->add(VideoI18nPeer::CODE, $this->code);
		if ($this->isColumnModified(VideoI18nPeer::TITLE)) $criteria->add(VideoI18nPeer::TITLE, $this->title);
		if ($this->isColumnModified(VideoI18nPeer::BODY)) $criteria->add(VideoI18nPeer::BODY, $this->body);
		if ($this->isColumnModified(VideoI18nPeer::AUTHOR)) $criteria->add(VideoI18nPeer::AUTHOR, $this->author);
		if ($this->isColumnModified(VideoI18nPeer::ID)) $criteria->add(VideoI18nPeer::ID, $this->id);
		if ($this->isColumnModified(VideoI18nPeer::CULTURE)) $criteria->add(VideoI18nPeer::CULTURE, $this->culture);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(VideoI18nPeer::CULTURE, $this->culture);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of VideoI18n (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     VideoI18n Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     VideoI18nPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new VideoI18nPeer();
		}
		return self::$peer;
	}
	...
	{
		if ($this->aVideo === null && ($this->id !== null)) {
			$this->aVideo = VideoPeer::retrieveByPk($this->id);
			/* The following can be used additionally to
			   guarantee the related object contains a reference
			   to this object.  This level of coupling may, however, be
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->aVideo->addVideoI18ns($this);
			 */
		}
		return $this->aVideo;
	}
	...
	{
	  if (!$callable = sfMixer::getCallable('BaseVideoI18n:'.$method))
	  {
	    throw new sfException(sprintf('Call to undefined method BaseVideoI18n::%s', $method));
	  }
