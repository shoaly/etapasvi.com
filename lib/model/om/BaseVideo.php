...
abstract class BaseVideo extends BaseObject  implements Persistent {
	...
	/**
	 * @var        array VideoI18n[] Collection to store aggregation of VideoI18n objects.
	 */
	protected $collVideoI18ns;

	/**
	 * @var        Criteria The criteria used to select the current contents of collVideoI18ns.
	 */
	private $lastVideoI18nCriteria = null;
	...
	public function setLive($v)
	{
		...
		if ($this->live !== $v || $this->isNew()) {
			if ($this->live === null && $v === '') {
			} else {
			  $this->modifiedColumns[] = VideoPeer::LIVE;
			}
			$this->live = $v;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->link = ($row[$startcol + 5] !== null) ? (string) $row[$startcol + 5] : null;
			$this->live = ($row[$startcol + 6] !== null) ? (boolean) $row[$startcol + 6] : null;
			$this->all_cultures = ($row[$startcol + 7] !== null) ? (boolean) $row[$startcol + 7] : null;
			$this->resetModified();
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		if ($deep) {  // also de-associate any related objects?
			...
			$this->collVideoI18ns = null;
			$this->lastVideoI18nCriteria = null;
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->collVideoI18ns !== null) {
				foreach ($this->collVideoI18ns as $referrerFK) {
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[6], $arr)) $this->setLive($arr[$keys[6]]);
		if (array_key_exists($keys[7], $arr)) $this->setAllCultures($arr[$keys[7]]);
	}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(VideoPeer::SHOW)) $criteria->add(VideoPeer::SHOW, $this->show);
		if ($this->isColumnModified(VideoPeer::ORDER)) $criteria->add(VideoPeer::ORDER, $this->order);
		if ($this->isColumnModified(VideoPeer::LINK)) $criteria->add(VideoPeer::LINK, $this->link);
		if ($this->isColumnModified(VideoPeer::LIVE)) $criteria->add(VideoPeer::LIVE, $this->live);
		if ($this->isColumnModified(VideoPeer::ALL_CULTURES)) $criteria->add(VideoPeer::ALL_CULTURES, $this->all_cultures);
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		if ($deepCopy) {
			...
			foreach ($this->getVideoI18ns() as $relObj) {
				if ($relObj !== $this) {  // ensure that we don't try to copy a reference to ourselves
					$copyObj->addVideoI18n($relObj->copy($deepCopy));
				}
			}
	...
	/**
	 * Clears out the collVideoI18ns collection (array).
	 *
	 ...
	 * @see        addVideoI18ns()
	 */
	public function clearVideoI18ns()
	{
		$this->collVideoI18ns = null; // important to set this to NULL since that means it is uninitialized
	}

	/**
	 * Initializes the collVideoI18ns collection (array).
	 *
	 * By default this just sets the collVideoI18ns collection to an empty array (like clearcollVideoI18ns());
	 * however, you may wish to override this method in your stub class to provide setting appropriate
	 * to your application -- for example, setting the initial array to the values stored in database.
	 *
	 * @return     void
	 */
	public function initVideoI18ns()
	{
		$this->collVideoI18ns = array();
	}

	/**
	 * Gets an array of VideoI18n objects which contain a foreign key that references this object.
	 *
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this Video has previously been saved, it will retrieve
	 * related VideoI18ns from storage. If this Video is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
	 * @return     array VideoI18n[]
	 * @throws     PropelException
	 */
	public function getVideoI18ns($criteria = null, PropelPDO $con = null)
	{
		if ($criteria === null) {
			$criteria = new Criteria(VideoPeer::DATABASE_NAME);
		}
		...
		if ($this->collVideoI18ns === null) {
			if ($this->isNew()) {
			   $this->collVideoI18ns = array();
				...
				$criteria->add(VideoI18nPeer::ID, $this->id);

				VideoI18nPeer::addSelectColumns($criteria);
				$this->collVideoI18ns = VideoI18nPeer::doSelect($criteria, $con);
			}
		} else {
			...
			if (!$this->isNew()) {
				...
				VideoI18nPeer::addSelectColumns($criteria);
				if (!isset($this->lastVideoI18nCriteria) || !$this->lastVideoI18nCriteria->equals($criteria)) {
					$this->collVideoI18ns = VideoI18nPeer::doSelect($criteria, $con);
				}
			}
		}
		$this->lastVideoI18nCriteria = $criteria;
		return $this->collVideoI18ns;
	}

	/**
	 * Returns the number of related VideoI18n objects.
	 *
	 * @param      Criteria $criteria
	 * @param      boolean $distinct
	 * @param      PropelPDO $con
	 * @return     int Count of related VideoI18n objects.
	 * @throws     PropelException
	 */
	public function countVideoI18ns(Criteria $criteria = null, $distinct = false, PropelPDO $con = null)
	{
		if ($criteria === null) {
			$criteria = new Criteria(VideoPeer::DATABASE_NAME);
		} else {
		...
		if ($this->collVideoI18ns === null) {
			if ($this->isNew()) {
				...
				$count = VideoI18nPeer::doCount($criteria, false, $con);
			}
		} else {
			// criteria has no effect for a new object
			if (!$this->isNew()) {
				...
				if (!isset($this->lastVideoI18nCriteria) || !$this->lastVideoI18nCriteria->equals($criteria)) {
					...
					$count = count($this->collVideoI18ns);
				}
			} else {
				$count = count($this->collVideoI18ns);
			}
	...
	/**
	 * Method called to associate a VideoI18n object to this object
	 * through the VideoI18n foreign key attribute.
	 *
	 * @param      VideoI18n $l VideoI18n
	 * @return     void
	 * @throws     PropelException
	 */
	public function addVideoI18n(VideoI18n $l)
	{
		if ($this->collVideoI18ns === null) {
			$this->initVideoI18ns();
		}
		if (!in_array($l, $this->collVideoI18ns, true)) { // only add it if the **same** object is not already associated
			array_push($this->collVideoI18ns, $l);
			$l->setVideo($this);
		}
	}
	...
	{
		if ($deep) {
			if ($this->collVideoI18ns) {
				foreach ((array) $this->collVideoI18ns as $o) {
	...
	/**
	 * Returns the "updated_at_extra" value from the current {@link VideoI18n}.
	 */
	public function getUpdatedAtExtra($culture = null)
	{
	  return $this->getCurrentVideoI18n($culture)->getUpdatedAtExtra();
	}
	
	/**
	 * Sets the "updated_at_extra" value of the current {@link VideoI18n}.
	 *
	 * @return Video
	 */
	public function setUpdatedAtExtra($value, $culture = null)
	{
	  $this->getCurrentVideoI18n($culture)->setUpdatedAtExtra($value);
	  return $this;
	}
	
	/**
	 * Returns the "img" value from the current {@link VideoI18n}.
	 */
	public function getImg($culture = null)
	{
	  return $this->getCurrentVideoI18n($culture)->getImg();
	}
	
	/**
	 * Sets the "img" value of the current {@link VideoI18n}.
	 *
	 * @return Video
	 */
	public function setImg($value, $culture = null)
	{
	  $this->getCurrentVideoI18n($culture)->setImg($value);
	  return $this;
	}
	
	/**
	 * Returns the "code" value from the current {@link VideoI18n}.
	 */
	public function getCode($culture = null)
	{
	  return $this->getCurrentVideoI18n($culture)->getCode();
	}
	
	/**
	 * Sets the "code" value of the current {@link VideoI18n}.
	 *
	 * @return Video
	 */
	public function setCode($value, $culture = null)
	{
	  $this->getCurrentVideoI18n($culture)->setCode($value);
	  return $this;
	}
	
	/**
	 * Returns the "title" value from the current {@link VideoI18n}.
	 */
	public function getTitle($culture = null)
	{
	  return $this->getCurrentVideoI18n($culture)->getTitle();
	}
	
	/**
	 * Sets the "title" value of the current {@link VideoI18n}.
	 *
	 * @return Video
	 */
	public function setTitle($value, $culture = null)
	{
	  $this->getCurrentVideoI18n($culture)->setTitle($value);
	  return $this;
	}
	
	/**
	 * Returns the "body" value from the current {@link VideoI18n}.
	 */
	public function getBody($culture = null)
	{
	  return $this->getCurrentVideoI18n($culture)->getBody();
	}
	
	/**
	 * Sets the "body" value of the current {@link VideoI18n}.
	 *
	 * @return Video
	 */
	public function setBody($value, $culture = null)
	{
	  $this->getCurrentVideoI18n($culture)->setBody($value);
	  return $this;
	}
	
	/**
	 * Returns the "author" value from the current {@link VideoI18n}.
	 */
	public function getAuthor($culture = null)
	{
	  return $this->getCurrentVideoI18n($culture)->getAuthor();
	}
	
	/**
	 * Sets the "author" value of the current {@link VideoI18n}.
	 *
	 * @return Video
	 */
	public function setAuthor($value, $culture = null)
	{
	  $this->getCurrentVideoI18n($culture)->setAuthor($value);
	  return $this;
	}
	 ...
	 * @return VideoI18n
	 */
	public function getCurrentVideoI18n($culture = null)
	{
	  if (null === $culture)
	  {
	  ...
	  {
	    $object = $this->isNew() ? null : VideoI18nPeer::retrieveByPK($this->getPrimaryKey(), $culture);
	    if ($object)
	    {
	      $this->setVideoI18nForCulture($object, $culture);
	    }
	    else
	    {
	      $this->setVideoI18nForCulture(new VideoI18n(), $culture);
	 ...
	 */
	public function setVideoI18nForCulture(VideoI18n $object, $culture)
	{
	  $this->current_i18n[$culture] = $object;
	  $this->addVideoI18n($object);
	}
