...
abstract class BaseQuotePeer {
	...
	const CLASS_DEFAULT = 'lib.model.Quote';
	...
	const SHOW = 'quote.SHOW';

	/** the column name for the NEWS_ID field */
	const NEWS_ID = 'quote.NEWS_ID';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Show', 'NewsId', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'show', 'newsId', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::SHOW, self::NEWS_ID, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'show', 'news_id', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Show' => 1, 'NewsId' => 2, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'show' => 1, 'newsId' => 2, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::SHOW => 1, self::NEWS_ID => 2, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'show' => 1, 'news_id' => 2, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, )
	);
	...
	{
		$criteria->addSelectColumn(QuotePeer::ID);
		$criteria->addSelectColumn(QuotePeer::SHOW);
		$criteria->addSelectColumn(QuotePeer::NEWS_ID);
	}
	...
	public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
	{
		...
		{
		  call_user_func($sf_hook, 'BaseQuotePeer', $criteria, $con);
		}
	 ...
	 *
	 * @param      Quote $value A Quote object.
	 * @param      string $key (optional) key to use for instance map (for performance boost if key was already calculated externally).
	 */
	public static function addInstanceToPool(Quote $obj, $key = null)
	{
	...
	{
		// invalidate objects in QuoteI18nPeer instance pool, since one or more of them may be deleted by ON DELETE CASCADE rule.
	...
	public static function doCountJoinNews(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(QuotePeer::NEWS_ID, NewsPeer::ID, $join_behavior);
	...
	/**
	 * Selects a collection of Quote objects pre-filled with their News objects.
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	public static function doSelectJoinNews(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		QuotePeer::addSelectColumns($criteria);
		$startcol = (QuotePeer::NUM_COLUMNS - QuotePeer::NUM_LAZY_LOAD_COLUMNS);
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Quote) to $obj2 (News)
				$obj2->addQuote($obj1);
	...
	public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		QuotePeer::addSelectColumns($criteria);
		$startcol2 = (QuotePeer::NUM_COLUMNS - QuotePeer::NUM_LAZY_LOAD_COLUMNS);
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Quote) to the collection in $obj2 (News)
				$obj2->addQuote($obj1);
	...
	{
		return $withPrefix ? QuotePeer::CLASS_DEFAULT : QuotePeer::OM_CLASS;
	}

	/**
	 * Method perform an INSERT on the database, given a Quote or Criteria object.
	 *
	...
	{
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseQuotePeer:doInsert:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BaseQuotePeer', $values, $con))
      {
		...
		if ($criteria->containsKey(QuotePeer::ID) && $criteria->keyContainsValue(QuotePeer::ID) ) {
			throw new PropelException('Cannot insert a value for auto-increment primary key ('.QuotePeer::ID.')');
		}
    ...
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseQuotePeer:doInsert:post') as $sf_hook)
    {
      call_user_func($sf_hook, 'BaseQuotePeer', $values, $con, $pk);
    }
	...
	/**
	 * Method perform an UPDATE on the database, given a Quote or Criteria object.
	 *
	...
	{
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseQuotePeer:doUpdate:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BaseQuotePeer', $values, $con))
      {
        return $sf_hook_retval;
		...
		if ($values instanceof Criteria) {
			...
			$comparison = $criteria->getComparison(QuotePeer::ID);
			$selectCriteria->add(QuotePeer::ID, $criteria->remove(QuotePeer::ID), $comparison);
    ...
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseQuotePeer:doUpdate:post') as $sf_hook)
    {
      call_user_func($sf_hook, 'BaseQuotePeer', $values, $con, $ret);
    }
	...
	/**
	 * Method to DELETE all rows from the quote table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	public static function doDeleteAll($con = null)
	{
		...
		try {
			...
			$affectedRows += BasePeer::doDeleteAll(QuotePeer::TABLE_NAME, $con);
	...
	/**
	 * Method perform a DELETE on the database, given a Quote or Criteria object OR a primary key value.
	 *
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		if ($values instanceof Criteria) {
			...
			$criteria->add(QuotePeer::ID, (array) $values, Criteria::IN);
		}
		...
		try {
			...
			// for more than one table or we could emulating ON DELETE CASCADE, etc.
			$con->beginTransaction();
			$affectedRows += QuotePeer::doOnDeleteCascade($criteria, $con);
	...
	protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
	{
		...
		foreach ($objects as $obj) {
			...
			// delete related QuoteI18n objects
			$criteria = new Criteria(QuoteI18nPeer::DATABASE_NAME);
			
			$criteria->add(QuoteI18nPeer::ID, $obj->getId());
			$affectedRows += QuoteI18nPeer::doDelete($criteria, $con);
		}
		return $affectedRows;
	}
	 ...
	 */
	public static function doValidate(Quote $obj, $cols = null)
	{
		$columns = array();
	...
	public static function retrieveByPKs($pks, PropelPDO $con = null)
	{
		...
		if (empty($pks)) {
			...
			$criteria = new Criteria(QuotePeer::DATABASE_NAME);
			$criteria->add(QuotePeer::ID, $pks, Criteria::IN);
	...
	static private function getMixerPreSelectHook($method)
	{
	  ...
	  {
	    return sprintf('BaseQuotePeer:%s:%1$s', 'Count' == $match[1] ? 'doCount' : $match[0]);
	  }
	...
	/**
	 * Selects a collection of {@link Quote} objects with a {@link QuoteI18n} translation populated.
	 *
	 * @param Criteria  $criteria
	...
	static public function doSelectWithI18n(Criteria $criteria, $culture = null, $con = null, $join_behavior = Criteria::LEFT_JOIN, $special_join = false)
	{
	  ...
	  if ($special_join) {
	    ...
	    $criteria->addJoin(
	      array(QuotePeer::ID, "(".QuoteI18nPeer::CULTURE),
	      array(QuoteI18nPeer::ID, "'{$culture}' OR 
					(".QuoteI18nPeer::CULTURE." = '{$default_culture}' AND NOT EXISTS(SELECT ".QuoteI18nPeer::ID." FROM ".QuoteI18nPeer::TABLE_NAME." 
					WHERE ".QuoteI18nPeer::ID." = ".QuotePeer::ID." AND ".QuoteI18nPeer::CULTURE." = '{$culture}')))"), 
	      $join_behavior
	    );
	  } else {
	  ...
	  {
	    call_user_func($sf_hook, 'Quote', $criteria, $con);
	  }
	  ...
	  $stmt = BasePeer::doSelect($criteria, $con);
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
	      ...
	      QuotePeer::addInstanceToPool($obj1, $key1);
			...
			$key2 = QuoteI18nPeer::getPrimaryKeyHashFromRow($row, $startcol);
			if ($key2 !== null) {
				$obj2 = QuoteI18nPeer::getInstanceFromPool($key2);
				if (!$obj2) {
					$cls = QuoteI18nPeer::getOMClass(false);
					$obj2 = new $cls();
					$obj2->hydrate($row, $startcol);
					QuoteI18nPeer::addInstanceToPool($obj2, $key2);
				} // if obj2 already loaded
	
	      $obj1->setQuoteI18nForCulture($obj2, $culture);
			} // if joined row was not null
