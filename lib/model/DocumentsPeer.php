...
class DocumentsPeer extends BaseDocumentsPeer {
   ...
   * @param unknown_type $c
   */
  public static function createFromHtml($html, $title, $item_id, $culture, $item_type_id)
  {  
  	$file = sfConfig::get('app_domain_name').'_'.strtolower(ItemtypesPeer::$item_type_names[ $item_type_id ])
  		    . '_' . $item_id . '_' . $culture . '.' . self::CREATE_FROM_HTML_FILE_EXTENSION;
