...
/**
 * This class defines the structure of the 'clearcache' table.
 *
 *
 ...
 */
class ClearcacheTableMap extends TableMap {

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'lib.model.map.ClearcacheTableMap';
	...
	public function initialize()
	{
	  // attributes
		...
		$this->setPhpName('Clearcache');
		$this->setClassname('Clearcache');
