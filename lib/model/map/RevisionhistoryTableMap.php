...
/**
 * This class defines the structure of the 'revisionhistory' table.
 *
 *
 ...
 */
class RevisionhistoryTableMap extends TableMap {

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'lib.model.map.RevisionhistoryTableMap';
	...
	{
	  // attributes
		$this->setName('revisionhistory');
		$this->setPhpName('Revisionhistory');
		$this->setClassname('Revisionhistory');
