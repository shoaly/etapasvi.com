...
class AnnouncementsTableMap extends TableMap {
	 ...
	 */
	const CLASS_NAME = 'lib.model.map.AnnouncementsTableMap';
	...
	public function initialize()
	{
	  // attributes
		...
		$this->setClassname('Announcements');
		...
		$this->addColumn('ACTIVE_TILL', 'ActiveTill', 'DATE', true, null, null);
	...
	{
    $this->addRelation('AnnouncementsI18n', 'AnnouncementsI18n', RelationMap::ONE_TO_MANY, array('id' => 'id', ), 'CASCADE', null);
	} // buildRelations()
	...
	public function getBehaviors()
	{
		return array(
			...
			'symfony_i18n' => array('i18n_table' => 'announcements_i18n', ),
		);
	} // getBehaviors()

} // AnnouncementsTableMap
