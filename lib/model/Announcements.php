...
require 'lib/model/om/BaseAnnouncements.php';


/**
 * Skeleton subclass for representing a row from the 'announcements' table.
 *
 *
 *
...
class Announcements extends BaseAnnouncements {
	...
	/**
	 * Initializes internal state of Announcements object.
...
/**
	...
	public function getUrl($culture = '') {
      ...
      $url_pattern = 'announcements/show?id=' . $this->getId();
	...
	public function getRssTitle() {
	  ...
	  return '[' . $i18n->__('Announcements') . '] ' . $this->getTitle($culture, true);
	}
	...
	{
	  $id_list = array();
	  $itemcategory_list = Item2itemcategoryPeer::getItemCategories(ItemtypesPeer::ITEM_TYPE_ANNOUNCEMENTS, $this->getId());
	...
	{
		return ItemtypesPeer::ITEM_TYPE_NAME_ANNOUNCEMENTS;
	}
